/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> abdera */
 
areaPosition[]={9445.85, 20294.8}; // Position x, y
areaRadiusA=243.83; // radius A of the location
areaRadiusB=280.91; // radius B of the location
