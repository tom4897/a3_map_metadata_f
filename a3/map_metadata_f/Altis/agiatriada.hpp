/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> agiatriada */
 
areaPosition[]={16626.2, 20586.8}; // Position x, y
areaRadiusA=127.35; // radius A of the location
areaRadiusB=196.44; // radius B of the location
areaAngle=322.83; // Rotation of the location
