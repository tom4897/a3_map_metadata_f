/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> agioskonstantinos */
 
areaPosition[]={4032.79, 17248}; // Position x, y
areaRadiusA=294.78; // radius A of the location
areaRadiusB=693.82; // radius B of the location
areaAngle=325.29; // Rotation of the location
