/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> airbase01 */
 
areaPosition[]={14270.6, 16227.9}; // Position x, y
areaRadiusA=213.21; // radius A of the location
areaRadiusB=385.37; // radius B of the location
areaAngle=39.66; // Rotation of the location
