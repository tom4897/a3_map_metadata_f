/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> aristi */
 
areaPosition[]={7941.1, 21313.5}; // Position x, y
areaRadiusA=60.07; // radius A of the location
areaRadiusB=92.1; // radius B of the location
