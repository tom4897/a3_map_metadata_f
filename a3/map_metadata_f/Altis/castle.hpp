/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> castle */
 
areaPosition[]={4843.36, 21921.6}; // Position x, y
areaRadiusA=167.11; // radius A of the location
areaRadiusB=143.21; // radius B of the location
