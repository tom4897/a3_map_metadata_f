/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> factory03 */
 
areaPosition[]={6220.82, 16215.4}; // Position x, y
areaRadiusA=216.14; // radius A of the location
areaRadiusB=120.22; // radius B of the location
