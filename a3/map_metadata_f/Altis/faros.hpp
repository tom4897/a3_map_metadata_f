/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> faros */
 
areaPosition[]={6593.24, 22646.8}; // Position x, y
areaRadiusA=58.79; // radius A of the location
areaRadiusB=96.97; // radius B of the location
areaAngle=314.04; // Rotation of the location
