/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> frini */
 
areaPosition[]={14674, 20835}; // Position x, y
areaRadiusA=251.22; // radius A of the location
areaRadiusB=381.39; // radius B of the location
areaAngle=306.85; // Rotation of the location
