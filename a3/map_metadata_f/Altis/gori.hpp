/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> gori */
 
areaPosition[]={5482.61, 17652.8}; // Position x, y
areaRadiusA=229.84; // radius A of the location
areaRadiusB=340.37; // radius B of the location
