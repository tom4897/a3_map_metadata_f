/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> gravia */
 
areaPosition[]={14618.6, 17660.3}; // Position x, y
areaRadiusA=318.47; // radius A of the location
areaRadiusB=389.64; // radius B of the location
areaAngle=317.77; // Rotation of the location
