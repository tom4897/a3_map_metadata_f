/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> ifestiona */
 
areaPosition[]={12869.2, 19671.7}; // Position x, y
areaRadiusA=188.4; // radius A of the location
areaRadiusB=219.38; // radius B of the location
areaAngle=44.39; // Rotation of the location
