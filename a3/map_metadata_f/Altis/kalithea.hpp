/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> kalithea */
 
areaPosition[]={17768.1, 18171.4}; // Position x, y
areaRadiusA=236.48; // radius A of the location
areaRadiusB=251.81; // radius B of the location
areaAngle=44.17; // Rotation of the location
