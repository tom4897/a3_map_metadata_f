/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> military02 */
 
areaPosition[]={15115.4, 17271.2}; // Position x, y
areaRadiusA=161.35; // radius A of the location
areaRadiusB=316.28; // radius B of the location
areaAngle=43.46; // Rotation of the location
