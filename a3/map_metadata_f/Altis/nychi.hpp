/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> nychi */
 
areaPosition[]={16880.7, 21936.9}; // Position x, y
areaRadiusA=198.46; // radius A of the location
areaRadiusB=105.2; // radius B of the location
areaAngle=340.97; // Rotation of the location
