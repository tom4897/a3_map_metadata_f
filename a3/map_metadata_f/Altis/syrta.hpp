/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> syrta */
 
areaPosition[]={8534.82, 18237.7}; // Position x, y
areaRadiusA=326.39; // radius A of the location
areaRadiusB=300.48; // radius B of the location
areaAngle=343.07; // Rotation of the location
