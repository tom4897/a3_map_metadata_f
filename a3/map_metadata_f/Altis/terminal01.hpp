/* [2017,10,10,14,02] */
/* CfgWorlds >> Altis >> Names >> terminal01 */
 
areaPosition[]={14662.7, 16783.5}; // Position x, y
areaRadiusA=230.9; // radius A of the location
areaRadiusB=230.78; // radius B of the location
areaAngle=42.84; // Rotation of the location
