/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_c_airport */
 
areaPosition[]={8076.63, 10070.9}; // Position x, y
areaRadiusA=361.58; // radius A of the location
areaRadiusB=836.64; // radius B of the location
areaAngle=0; // Rotation of the location
demography=MIL; // Demography
