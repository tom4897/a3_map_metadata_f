/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_c_lapessagne */
 
areaPosition[]={3145.07, 6163.13}; // Position x, y
areaRadiusA=365.69; // radius A of the location
areaRadiusB=242.28; // radius B of the location
areaAngle=291.92; // Rotation of the location
