/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_arette */
 
areaPosition[]={1563.52, 4656.05}; // Position x, y
areaRadiusA=125.32; // radius A of the location
areaRadiusB=151.27; // radius B of the location
