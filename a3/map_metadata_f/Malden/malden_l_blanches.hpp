/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_blanches */
 
areaPosition[]={4707.25, 4101.6}; // Position x, y
areaRadiusA=439.16; // radius A of the location
areaRadiusB=223.94; // radius B of the location
areaAngle=32.64; // Rotation of the location
