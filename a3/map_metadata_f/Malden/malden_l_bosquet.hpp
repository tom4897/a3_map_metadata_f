/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_bosquet */
 
areaPosition[]={7909.88, 8986.09}; // Position x, y
areaRadiusA=124.66; // radius A of the location
areaRadiusB=184.52; // radius B of the location
