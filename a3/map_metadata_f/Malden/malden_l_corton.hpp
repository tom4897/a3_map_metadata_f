/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_corton */
 
areaPosition[]={3858.24, 4837.37}; // Position x, y
areaRadiusA=213.65; // radius A of the location
areaRadiusB=117.51; // radius B of the location
areaAngle=43.66; // Rotation of the location
