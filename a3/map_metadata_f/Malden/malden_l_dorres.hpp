/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_dorres */
 
areaPosition[]={5156.77, 4523.82}; // Position x, y
areaRadiusA=244.88; // radius A of the location
areaRadiusB=402.06; // radius B of the location
areaAngle=1.65; // Rotation of the location
