/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_faro */
 
areaPosition[]={1109.6, 656.695}; // Position x, y
areaRadiusA=229.63; // radius A of the location
areaRadiusB=181.55; // radius B of the location
