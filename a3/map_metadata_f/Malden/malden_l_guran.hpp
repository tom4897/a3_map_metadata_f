/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_guran */
 
areaPosition[]={6658.52, 6045.52}; // Position x, y
areaRadiusA=131.74; // radius A of the location
areaRadiusB=87.86; // radius B of the location
areaAngle=344.49; // Rotation of the location
