/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_lavalle */
 
areaPosition[]={5041.41, 7378.33}; // Position x, y
areaRadiusA=124.33; // radius A of the location
areaRadiusB=97.46; // radius B of the location
areaAngle=46.04; // Rotation of the location
