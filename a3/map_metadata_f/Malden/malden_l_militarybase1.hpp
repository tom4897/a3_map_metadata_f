/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_militarybase1 */
 
areaPosition[]={7576.32, 10652.1}; // Position x, y
areaRadiusA=141.02; // radius A of the location
areaRadiusB=204.73; // radius B of the location
areaAngle=40.88; // Rotation of the location
