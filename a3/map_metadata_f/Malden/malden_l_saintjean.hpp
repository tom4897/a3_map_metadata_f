/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_saintjean */
 
areaPosition[]={4555.87, 8086.67}; // Position x, y
areaRadiusA=218.82; // radius A of the location
areaRadiusB=405.19; // radius B of the location
areaAngle=338.32; // Rotation of the location
