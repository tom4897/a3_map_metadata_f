/* [2017,10,10,13,49] */
/* CfgWorlds >> Malden >> Names >> malden_l_saintmartin */
 
areaPosition[]={4375.56, 2813.6}; // Position x, y
areaRadiusA=144.94; // radius A of the location
areaRadiusB=103.17; // radius B of the location
