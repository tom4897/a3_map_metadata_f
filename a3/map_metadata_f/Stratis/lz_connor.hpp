/* [2017,10,10,14,00] */
/* CfgWorlds >> Stratis >> Names >> lz_connor */
 
areaPosition[]={2983.73, 1868.69}; // Position x, y
areaRadiusA=53.07; // radius A of the location
areaRadiusB=55.87; // radius B of the location
