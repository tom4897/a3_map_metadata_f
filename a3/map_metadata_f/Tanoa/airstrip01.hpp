/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> airstrip01 */
 
areaPosition[]={2195.5, 3487.23}; // Position x, y
areaRadiusA=343.48; // radius A of the location
areaRadiusB=169.67; // radius B of the location
areaAngle=343.01; // Rotation of the location
