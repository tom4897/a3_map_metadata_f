/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> airstrip03 */
 
areaPosition[]={11677.2, 3117.58}; // Position x, y
areaRadiusA=152.81; // radius A of the location
areaRadiusB=461.43; // radius B of the location
areaAngle=308.38; // Rotation of the location
