/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> airstrip04 */
 
areaPosition[]={2103.83, 13138.7}; // Position x, y
areaRadiusA=251.5; // radius A of the location
areaRadiusB=497.7; // radius B of the location
areaAngle=47.9; // Rotation of the location
