/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> balavu01 */
 
areaPosition[]={2671.96, 7183.65}; // Position x, y
areaRadiusA=384.46; // radius A of the location
areaRadiusB=285.14; // radius B of the location
areaAngle=25; // Rotation of the location
