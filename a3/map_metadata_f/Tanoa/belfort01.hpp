/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> belfort01 */
 
areaPosition[]={3152.77, 11222.7}; // Position x, y
areaRadiusA=336.18; // radius A of the location
areaRadiusB=312.17; // radius B of the location
