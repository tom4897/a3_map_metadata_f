/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> buawa01 */
 
areaPosition[]={8272.47, 11118.5}; // Position x, y
areaRadiusA=153.03; // radius A of the location
areaRadiusB=184.75; // radius B of the location
