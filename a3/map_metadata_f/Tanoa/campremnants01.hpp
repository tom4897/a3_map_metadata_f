/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> campremnants01 */
 
areaPosition[]={3886.73, 13951}; // Position x, y
areaRadiusA=98.5; // radius A of the location
areaRadiusB=179.03; // radius B of the location
areaAngle=319.21; // Rotation of the location
