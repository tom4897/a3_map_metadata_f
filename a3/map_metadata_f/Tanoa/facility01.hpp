/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> facility01 */
 
areaPosition[]={10052.7, 11782.5}; // Position x, y
areaRadiusA=280.18; // radius A of the location
areaRadiusB=199.75; // radius B of the location
