/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> facility02 */
 
areaPosition[]={11058, 11497.6}; // Position x, y
areaRadiusA=329.18; // radius A of the location
areaRadiusB=236.91; // radius B of the location
