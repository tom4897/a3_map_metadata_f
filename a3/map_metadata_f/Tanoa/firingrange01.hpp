/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> firingrange01 */
 
areaPosition[]={3375.57, 12858.1}; // Position x, y
areaRadiusA=113.75; // radius A of the location
areaRadiusB=73.98; // radius B of the location
