/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> forestclearing01 */
 
areaPosition[]={12303.8, 3897}; // Position x, y
areaRadiusA=261.08; // radius A of the location
areaRadiusB=134.89; // radius B of the location
areaAngle=327.88; // Rotation of the location
