/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> fortressruins01 */
 
areaPosition[]={12087.5, 2487.4}; // Position x, y
areaRadiusA=142.49; // radius A of the location
areaRadiusB=131.78; // radius B of the location
