/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> harbourremnants01 */
 
areaPosition[]={4188.31, 11686.7}; // Position x, y
areaRadiusA=146.23; // radius A of the location
areaRadiusB=83.03; // radius B of the location
areaAngle=328.85; // Rotation of the location
