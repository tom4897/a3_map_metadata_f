/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> harcourt01 */
 
areaPosition[]={11256.5, 5226.69}; // Position x, y
areaRadiusA=338.66; // radius A of the location
areaRadiusB=214.53; // radius B of the location
areaAngle=344.78; // Rotation of the location
