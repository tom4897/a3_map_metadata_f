/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> indport01 */
 
areaPosition[]={13534.9, 12125.9}; // Position x, y
areaRadiusA=682.24; // radius A of the location
areaRadiusB=594.83; // radius B of the location
