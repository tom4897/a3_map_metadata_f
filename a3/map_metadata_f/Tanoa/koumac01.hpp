/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> koumac01 */
 
areaPosition[]={1386.53, 2991.89}; // Position x, y
areaRadiusA=280.39; // radius A of the location
areaRadiusB=163.17; // radius B of the location
