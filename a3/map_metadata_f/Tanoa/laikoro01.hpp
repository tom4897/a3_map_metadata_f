/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> laikoro01 */
 
areaPosition[]={1858.96, 6254.28}; // Position x, y
areaRadiusA=305.98; // radius A of the location
areaRadiusB=235; // radius B of the location
areaAngle=327.33; // Rotation of the location
