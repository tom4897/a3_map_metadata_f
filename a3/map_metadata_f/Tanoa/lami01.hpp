/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> lami01 */
 
areaPosition[]={8014.73, 7516.06}; // Position x, y
areaRadiusA=636.12; // radius A of the location
areaRadiusB=501.65; // radius B of the location
