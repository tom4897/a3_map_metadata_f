/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> leqa01 */
 
areaPosition[]={2363.78, 8171.96}; // Position x, y
areaRadiusA=119.88; // radius A of the location
areaRadiusB=104.48; // radius B of the location
