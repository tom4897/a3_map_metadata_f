/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> lifou01 */
 
areaPosition[]={7274.42, 8042.95}; // Position x, y
areaRadiusA=291.87; // radius A of the location
areaRadiusB=274.51; // radius B of the location
