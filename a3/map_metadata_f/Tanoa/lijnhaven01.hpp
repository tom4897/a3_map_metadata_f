/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> lijnhaven01 */
 
areaPosition[]={11780.1, 2593.5}; // Position x, y
areaRadiusA=690.02; // radius A of the location
areaRadiusB=595.54; // radius B of the location
areaAngle=20.79; // Rotation of the location
