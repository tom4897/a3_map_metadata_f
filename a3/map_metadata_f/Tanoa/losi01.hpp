/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> losi01 */
 
areaPosition[]={10190.7, 5030.74}; // Position x, y
areaRadiusA=144.09; // radius A of the location
areaRadiusB=96.74; // radius B of the location
areaAngle=330.8; // Rotation of the location
