/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> lumberyard02 */
 
areaPosition[]={8869.48, 11917.4}; // Position x, y
areaRadiusA=189.87; // radius A of the location
areaRadiusB=130.8; // radius B of the location
