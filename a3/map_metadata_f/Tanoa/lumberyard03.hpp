/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> lumberyard03 */
 
areaPosition[]={9364.52, 7488.27}; // Position x, y
areaRadiusA=217.07; // radius A of the location
areaRadiusB=215.72; // radius B of the location
