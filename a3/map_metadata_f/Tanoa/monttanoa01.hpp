/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> monttanoa01 */
 
areaPosition[]={10068.9, 12090.4}; // Position x, y
areaRadiusA=473.93; // radius A of the location
areaRadiusB=446.02; // radius B of the location
