/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> namuvaka01 */
 
areaPosition[]={2739.38, 5659.15}; // Position x, y
areaRadiusA=225.02; // radius A of the location
areaRadiusB=141.32; // radius B of the location
areaAngle=27.47; // Rotation of the location
