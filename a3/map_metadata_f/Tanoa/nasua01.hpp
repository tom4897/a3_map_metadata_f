/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> nasua01 */
 
areaPosition[]={11358.3, 12322.6}; // Position x, y
areaRadiusA=226.54; // radius A of the location
areaRadiusB=199.34; // radius B of the location
