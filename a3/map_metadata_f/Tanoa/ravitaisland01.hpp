/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> ravitaisland01 */
 
areaPosition[]={12700.9, 14035.4}; // Position x, y
areaRadiusA=819.01; // radius A of the location
areaRadiusB=428.14; // radius B of the location
areaAngle=20.82; // Rotation of the location
