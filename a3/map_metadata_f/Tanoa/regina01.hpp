/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> regina01 */
 
areaPosition[]={5090.53, 8691.72}; // Position x, y
areaRadiusA=572.45; // radius A of the location
areaRadiusB=243.06; // radius B of the location
