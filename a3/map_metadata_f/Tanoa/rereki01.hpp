/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> rereki01 */
 
areaPosition[]={13014.3, 2096.59}; // Position x, y
areaRadiusA=101.37; // radius A of the location
areaRadiusB=115.16; // radius B of the location
areaAngle=41.28; // Rotation of the location
