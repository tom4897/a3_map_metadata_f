/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> savu01 */
 
areaPosition[]={8471.9, 13723}; // Position x, y
areaRadiusA=186.41; // radius A of the location
areaRadiusB=345.01; // radius B of the location
areaAngle=70.07; // Rotation of the location
