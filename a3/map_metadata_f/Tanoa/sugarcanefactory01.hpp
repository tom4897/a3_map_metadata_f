/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> sugarcanefactory01 */
 
areaPosition[]={8378.73, 10277.2}; // Position x, y
areaRadiusA=211.11; // radius A of the location
areaRadiusB=222.02; // radius B of the location
