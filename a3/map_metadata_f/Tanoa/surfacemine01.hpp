/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> surfacemine01 */
 
areaPosition[]={11919, 10399.3}; // Position x, y
areaRadiusA=638.76; // radius A of the location
areaRadiusB=453.46; // radius B of the location
areaAngle=348.13; // Rotation of the location
