/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> tanouka01 */
 
areaPosition[]={8859.69, 10135.7}; // Position x, y
areaRadiusA=355.62; // radius A of the location
areaRadiusB=353.82; // radius B of the location
