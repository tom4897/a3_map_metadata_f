/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> templeruins01 */
 
areaPosition[]={11034.3, 8463.96}; // Position x, y
areaRadiusA=117.68; // radius A of the location
areaRadiusB=110.35; // radius B of the location
