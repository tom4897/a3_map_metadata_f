/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> tobakoro01 */
 
areaPosition[]={8835.79, 3556.68}; // Position x, y
areaRadiusA=240.25; // radius A of the location
areaRadiusB=221.46; // radius B of the location
areaAngle=319.62; // Rotation of the location
