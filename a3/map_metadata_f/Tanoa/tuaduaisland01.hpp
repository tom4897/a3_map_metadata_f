/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> tuaduaisland01 */
 
areaPosition[]={8538.23, 1263.1}; // Position x, y
areaRadiusA=310.44; // radius A of the location
areaRadiusB=519.51; // radius B of the location
areaAngle=308.1; // Rotation of the location
