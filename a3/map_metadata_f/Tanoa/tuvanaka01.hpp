/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> tuvanaka01 */
 
areaPosition[]={1827.53, 12012.5}; // Position x, y
areaRadiusA=272.56; // radius A of the location
areaRadiusB=318.91; // radius B of the location
areaAngle=334.31; // Rotation of the location
