/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> vagalala01 */

areaPosition[]={11037.1, 9745.83}; // Position x, y
areaRadiusA=326.61; // radius A of the location
areaRadiusB=331.74; // radius B of the location
