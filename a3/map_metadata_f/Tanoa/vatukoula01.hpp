/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> vatukoula01 */
 
areaPosition[]={14022.7, 9958.4}; // Position x, y
areaRadiusA=168.91; // radius A of the location
areaRadiusB=74.73; // radius B of the location
areaAngle=16.89; // Rotation of the location
