/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> yanukka01 */
 
areaPosition[]={3101.76, 3478.23}; // Position x, y
areaRadiusA=363.14; // radius A of the location
areaRadiusB=298.21; // radius B of the location
