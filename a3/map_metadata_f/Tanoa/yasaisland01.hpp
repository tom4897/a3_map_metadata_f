/* [2017,10,10,13,52] */
/* CfgWorlds >> Tanoa >> Names >> yasaisland01 */
 
areaPosition[]={3682.63, 9375.85}; // Position x, y
areaRadiusA=298.94; // radius A of the location
areaRadiusB=436.1; // radius B of the location
